    ...
    <div className="space-y-16">
      ...
      <section className="text-center py-12 bg-gradient-to-br from-slate-50 to-emerald-50 rounded-2xl">
        <div className="max-w-4xl mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-bold text-slate-800 mb-6">
            Entre em <span className="text-emerald-600">Contato conosco</span>
          </h1>
      ...
      <section className="grid lg:grid-cols-2 gap-12">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-lg border border-slate-200">
          <h2 className="text-2xl font-bold text-slate-800 mb-6">
            Envie sua <span className="text-emerald-600">Mensagem</span>
          </h2>
        ...
        <div className="space-y-8">
          <div>
            <h2 className="text-2xl font-bold text-slate-800 mb-6">
              Informações de <span className="text-emerald-600">Contato</span>
            </h2>
      ...
      <section className="bg-slate-50 rounded-2xl p-8">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold text-slate-800 mb-4">
            Nossa <span className="text-emerald-600">Localização</span>
          </h2>
        ...
        <div className="bg-white rounded-xl p-6 shadow-lg border border-slate-200">
          <div className="aspect-video bg-slate-200 rounded-lg flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-sm text-slate-500">Rua das Flores, 123 - Vila Madalena, São Paulo/SP</p>
            </div>
          </div>
          ...
          <div className="mt-6 grid md:grid-cols-3 gap-4 text-center">
            ...
            <div className="p-4 bg-emerald-50 rounded-lg">
              <span className="text-2xl block mb-2">🚇</span>
              <p className="font-medium text-slate-800">Metrô</p>
              <p className="text-sm text-slate-600">Vila Madalena</p>
            </div>
            <div className="p-4 bg-emerald-50 rounded-lg">
              <span className="text-2xl block mb-2">🚌</span>
              <p className="font-medium text-slate-800">Ônibus</p>
              <p className="text-sm text-slate-600">Várias linhas</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-white rounded-xl p-6 shadow-lg border border-slate-200">
            <h3 className="text-lg font-bold text-slate-800 mb-3">Como agendar uma consulta?</h3>
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border border-slate-200">
            <h3 className="text-lg font-bold text-slate-800 mb-3">Aceitam convênios?</h3>
            <p className="text-slate-600 text-sm">
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border border-slate-200">
            <h3 className="text-lg font-bold text-slate-800 mb-3">Qual o prazo para resposta?</h3>
            <p className="text-slate-600 text-sm">
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border border-slate-200">
            <h3 className="text-lg font-bold text-slate-800 mb-3">Fazem atendimento de emergência?</h3>
            <p className="text-slate-600 text-sm">
