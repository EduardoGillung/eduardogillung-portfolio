              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-300">Equipamentos modernos para diagnósticos precisos</p>
                  </div>
                </div>
                <div className="flex items-center space-x-4">
                  <div className="w-12 h-12 bg-gradient-to-br from-cyan-900 to-blue-900 rounded-full flex items-center justify-center">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h3 className="font-bold text-slate-100">Preços Justos</h3>
                    <p className="text-slate-300">Planos de tratamento acessíveis</p>
                  </div>
                </div>
              </div>
            </div>
